...
`;function K1(){const j=T1(),[B,M]=je.useState(()=>Q1()),d=je.useCallback(()=>{M(U=>U==="dark"?"light":"dark")},[]);return je.useEffect(()=>{document.documentElement.dataset.theme=B,localStorage.setItem("theme",B)},[B]),r.jsxs(r.Fragment,{children:[r.jsx("style",{children:V1}),r.jsx(j1,{}),j==="cv"?r.jsx(Y1,{theme:B,onToggleTheme:d}):j==="career"?r.jsx(R1,{theme:B,onToggleTheme:d}):r.jsx(Z1,{theme:B,onToggleTheme:d})]})}E1.createRoot(document.getElementById("root")).render(r.jsx(je.StrictMode,{children:r.jsx(K1,{})}));
